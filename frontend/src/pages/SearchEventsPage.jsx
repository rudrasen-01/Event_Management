      ...
      <div className="bg-white border-b sticky top-16 z-30 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex flex-col sm:flex-row gap-2 items-stretch">
            ...
            <div className="flex-1 h-12 border-2 border-gray-300 rounded-lg shadow-md hover:border-gray-400 hover:shadow-lg focus-within:border-gray-500 focus-within:shadow-lg transition-all bg-white">
              <SearchAutocomplete
                onSelect={(suggestion) => {
                ...
                placeholder="What are you looking for? (e.g., Photographer, Venue, Caterer)"
                className="h-full"
            ...
            {/* Location Selector - Fixed width */}
            <div className="w-full sm:w-80 relative flex items-center gap-2 px-4 h-12 border-2 border-gray-300 rounded-lg shadow-md hover:border-gray-400 hover:shadow-lg focus-within:border-gray-500 focus-within:shadow-lg transition-all bg-white">
              ...
              <div className="relative flex-1">
                <input
                  ...
                  placeholder="City"
                  className="w-full text-sm font-semibold placeholder-gray-400 focus:outline-none bg-transparent"
                />
                
                {showCityDropdown && !loadingFilters && (
                  <div className="absolute top-full left-0 mt-2 w-64 bg-white border-2 border-gray-300 rounded-lg shadow-xl z-[100] max-h-64 overflow-y-auto">
                    {cities
                      ...
                      .map((city) => (
                        <button
                          ...
                          className="w-full px-4 py-2.5 text-left hover:bg-gray-100 active:bg-gray-200 transition-colors border-b border-gray-100 last:border-b-0"
                        >
                ...
                <>
                  ...
                  <div className="relative flex-1">
                    ...
                    {showAreaDropdown && availableAreas.length > 0 && (
                      <div className="absolute top-full right-0 mt-2 w-64 bg-white border-2 border-gray-300 rounded-lg shadow-xl z-[100] max-h-64 overflow-y-auto">
                        {availableAreas
                          ...
                          .map((area) => (
                            <button
                              ...
                              className="w-full px-4 py-2.5 text-left hover:bg-gray-100 active:bg-gray-200 transition-colors text-sm font-semibold text-gray-900 border-b border-gray-100 last:border-b-0"
                            >
                              {area}
                            </button>
                          ))}
                      ...
                      <div className="space-y-2 max-h-64 overflow-y-auto">
                        {loadingFilters ? (
                          ...
                          filteredServiceTypes.map(service => (
                            <label key={service.value} className="flex items-center gap-2 cursor-pointer group py-1">
                              <input
                                type="radio"
                                name="serviceType"
